...
namespace LibraryManagementAPI.DTOs
{
    public static class ConfigurationService
    {
        ...
        {
            service.AddDbContext<BookDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("BookApiConnectString"),
                options => options.MigrationsAssembly(typeof(BookDbContext).Assembly.FullName)));
        }
